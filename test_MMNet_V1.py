...
if __name__ == '__main__':
    ...
    test_dataset = DatasetUofSC('./UofSC_Test_V4', split='test')
    ...
    model_path = './trained/checkpoints/2024-12-31T13:16:27.595562/MMNet_ChBest.pt'#'./trained/MMNet_ChBest.pt'
    ...
    for data in test_data_loader:
        ...
        print(x_ini.shape,x_pos.shape,gt_pcd.shape)
        ...
        savemat("output/modified0/result"+str(step)+".mat", gen_data)
        step = step + 1
    print(loss_g/len(test_dataset))
save_txt("output/modified0/chd_loss.txt",np.array(each_chd))
save_txt("output/modified0/emd_loss.txt",np.array(each_emd))

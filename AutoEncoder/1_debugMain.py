...
def pointcloud_openradar(file_name):
    ...
    binPath = "/".join(file_name.split("/")[:-1])
    bin_filename = binPath + '/only_sensor_' + info_dict['filename'][0]
...
if __name__ == "__main__":
    try:
        ...
        with concurrent.futures.ProcessPoolExecutor(max_workers=9) as file_executor:
